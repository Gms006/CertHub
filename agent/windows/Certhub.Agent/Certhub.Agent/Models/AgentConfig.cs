...
public sealed class AgentConfig
{
    ...
    public const int DefaultInstalledCertsReportIntervalSeconds = 30;
    ...
    public int InstalledCertsReportIntervalSeconds { get; set; } = DefaultInstalledCertsReportIntervalSeconds;
    ...
    public bool IsValid() =>
        ...
        && InstalledCertsReportIntervalSeconds >= 0;
}
